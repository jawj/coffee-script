(function() {
  ...
  exports.For = For = (function() {
    ...
    function For(body, source) {
      var _ref2;
      this.source = source.source, this.guard = source.guard, this.step = source.step, this.name = source.name, this.index = source.index, this.names = source.names;
    ...
    For.prototype.compileNode = function(o) {
      var aName, aSource, allLengths, anSvar, body, defPart, forPart, forVarPart, guardPart, i, idt1, index, ivar, lastJumps, lvar, maxLength, multiSource, name, namePart, names, ref, resultPart, returnResult, rvar, scope, source, stepPart, stepvar, svar, varPart, _len, _ref2, _ref3, _ref4;
      multiSource = this.source instanceof Array;
      ...
      index = multiSource ? (_ref3 = this.names[this.source.length]) != null ? _ref3.compile(o, LEVEL_LIST) : void 0 : this.index && this.index.compile(o, LEVEL_LIST);
      ...
      if (this.range) {
        ...
        svar = (function() {
          ...
          if (multiSource) {
            ...
            for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
              aSource = _ref4[_i];
              _results.push(aSource.compile(o, LEVEL_LIST));
            }
            return _results;
          } else {
            return this.source.compile(o, LEVEL_LIST);
          }
        }).call(this);
        if (name || this.own) {
          if (!multiSource && !IDENTIFIER.test(svar)) {
            ...
            svar = (function() {
              var _i, _len, _results;
              _results = [];
              for (_i = 0, _len = svar.length; _i < _len; _i++) {
                anSvar = svar[_i];
                if (IDENTIFIER.test(anSvar)) {
                  _results.push(anSvar);
                } else {
                  defPart += "" + this.tab + (ref = scope.freeVariable('ref')) + " = " + anSvar + ";\n";
                  _results.push(ref);
                }
              }
              return _results;
        ...
        if (name && !this.pattern) {
          namePart = multiSource ? (names = (function() {
            var _i, _len, _ref4, _results;
            _ref4 = this.names;
            _results = [];
            for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
              aName = _ref4[_i];
              _results.push(aName.compile(o, LEVEL_LIST));
            }
            return _results;
          }).call(this), ((function() {
            var _len, _results;
            ...
            for (i = 0, _len = names.length; i < _len; i++) {
              aName = names[i];
              if (i < svar.length) {
                _results.push("" + aName + " = " + svar[i] + "[" + ivar + "]");
              }
            }
            return _results;
          })()).join('; ')) : "" + name + " = " + svar + "[" + ivar + "]";
        ...
        if (!this.object) {
          ...
          maxLength = multiSource ? (allLengths = ((function() {
            var _i, _len, _results;
            _results = [];
            for (_i = 0, _len = svar.length; _i < _len; _i++) {
              anSvar = svar[_i];
              _results.push("" + anSvar + ".length");
            }
            return _results;
          })()).join(', '), "Math.max(" + allLengths + ")") : "" + svar + ".length";
          forVarPart = ("" + ivar + " = 0, " + lvar + " = " + maxLength) + (this.step ? ", " + stepvar + " = " + (this.step.compile(o, LEVEL_OP)) : '');
